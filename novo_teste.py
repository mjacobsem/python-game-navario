...
tire_image = pygame.image.load("fireball.gif")
enemy_image = pygame.image.load("bloco.png")
score_image = pygame.image.load("moeda.png")
vida_image = pygame.image.load("vida.png")
fundo_image = pygame.image.load("fundo.png")

# Som de acerto
acertou_sound = pygame.mixer.Sound("som_moeda.mp3")
